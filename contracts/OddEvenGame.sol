...
contract OddEvenGame{
    ...
    function playGame(uint8 numberP2) public {
        require(gameData.choiceP1 != 0, "first choose your option: 1 = even, 2 = odd!");
        ...
        // Corrected logic for determining the winner
        if ((isEven && gameData.choiceP1 == 1) || (!isEven && gameData.choiceP1 == 2)) {
            gameData.lastWinner = 1; // Player 1 wins
        } else {
            gameData.lastWinner = 2; // Player 2 wins
        }
